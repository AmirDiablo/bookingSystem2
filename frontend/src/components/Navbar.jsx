...
const Navbar = () => {
    const {user, setIsSearching, isSearching} = useUser()
    ...
    return ( 
        <div className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 h-16 md:px-16 lg:px-36 py-5">
            ...
            <div className="flex items-center gap-3 min-md:gap-8">
                <FiSearch onClick={()=> setIsSearching(!isSearching)} className=" w-6 h-6 cursor-pointer" />
                { user ?
